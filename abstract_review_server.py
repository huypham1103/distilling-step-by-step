...
STATE_PATH = ROOT / "ABSTRACT_REVIEW_STATE.json"
HTML_PATH = ROOT / "ABSTRACT_REVIEW.html"
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path in ("/", "/ABSTRACT_REVIEW.html"):
...
if __name__ == "__main__":
    ...
    print("Abstract review server running at http://127.0.0.1:8772/ABSTRACT_REVIEW.html")
