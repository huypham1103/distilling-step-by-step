...
STATE_PATH = ROOT / "EXPERIMENTS_REVIEW_STATE.json"
HTML_PATH = ROOT / "EXPERIMENTS_REVIEW.html"
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path in ("/", "/EXPERIMENTS_REVIEW.html"):
...
if __name__ == "__main__":
    ...
    print("Experiments review server running at http://127.0.0.1:8768/EXPERIMENTS_REVIEW.html")
