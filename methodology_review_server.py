...
STATE_PATH = ROOT / "METHODOLOGY_REVIEW_STATE.json"
HTML_PATH = ROOT / "METHODOLOGY_REVIEW.html"
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path in ("/", "/METHODOLOGY_REVIEW.html"):
...
if __name__ == "__main__":
    ...
    print("Methodology review server running at http://127.0.0.1:8767/METHODOLOGY_REVIEW.html")
