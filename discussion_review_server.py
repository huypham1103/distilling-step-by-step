...
STATE_PATH = ROOT / "DISCUSSION_REVIEW_STATE.json"
HTML_PATH = ROOT / "DISCUSSION_REVIEW.html"
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path in ("/", "/DISCUSSION_REVIEW.html"):
...
if __name__ == "__main__":
    ...
    print("Discussion review server running at http://127.0.0.1:8770/DISCUSSION_REVIEW.html")
