...
STATE_PATH = ROOT / "RELATED_WORK_REVIEW_STATE.json"
HTML_PATH = ROOT / "RELATED_WORK_REVIEW.html"
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path in ("/", "/RELATED_WORK_REVIEW.html"):
...
if __name__ == "__main__":
    ...
    print("Related Work review server running at http://127.0.0.1:8766/RELATED_WORK_REVIEW.html")
